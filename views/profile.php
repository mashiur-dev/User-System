...
{
    addPost($_SESSION['LOGGED']['id'], $_POST['post-content']);
}
;
?>
<!doctype html>
...
<head>
    ...
    <title>Profile - User System App</title>
</head>
...
<body>
    ...
    <div class="mx-auto mt-5 max-w-screen-lg">
        <div class="lg:flex lg:items-center lg:justify-between">
            <div class="min-w-0 flex-1">
                <img class="inline-block h-24 w-24 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=500&h=500&q=80" alt="">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight"><?php echo $_SESSION['LOGGED']['name']; ?></h2>
                <h4 class="text-xl font-samibold leading-7 text-gray-900 sm:truncate"><?php echo $_SESSION['LOGGED']['title']; ?></h4>
            ...
            <div class="border-t border-gray-200">
                <dl>
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">Skilled in</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">HTML, CSS, PHP, JS, REACT</dd>
                    </div>
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">Email address</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0"><?php echo $_SESSION['LOGGED']['email']; ?></dd>
                    </div>
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <div class="mx-auto my-20 max-w-screen-lg overflow-hidden shadow sm:rounded-md">
            <div class="bg-white px-4 py-5 sm:p-6">
                <div class="col-span-6 sm:col-span-3">
                    <textarea rows="8" name="post-content" id="post-content" class="mt-1 p-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="What's in your mind?"></textarea>
                </div>
